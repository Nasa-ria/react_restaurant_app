    ...
    return (
        <>
            ...
            <section className='info_section' id="info">
                    ...
                    <p className='info_supheading' style={{ marginTop: "5em" }}><em>please check the Yelp or Google listings for any holiday closures</em> </p>
            ...
            <section className='media' >
                    <h3 className='press_topic' id='press' >PRESS</h3>
